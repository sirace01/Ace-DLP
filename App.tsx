...
const App: React.FC = () => {
  ...
  const handleGenerateLessonPlan = useCallback(async () => {
    ...
    try {
      ...
      ${pdfContext}
      Generate one student-centered cognitive, one psychomotor, and one affective learning objective for a lesson titled "${lessonTitle}" in ${learningArea}.
      ...
      Generate the Content Standard, Performance Standards, and Learning Competency. Focus on student-centered outcomes and numeracy where applicable.
      Provide the output in a structured JSON format:
      \`\`\`json
      {
        "contentStandard": "...",
      ...
      Ensure the procedures align with the objectives, IDF features, and 21st-century skills.
      ${proceduresContext}
  ...
  }, [lessonTitle, learningArea, allIDFComponents, pdfTextContent]);
      ...
      <div className="mb-8 p-6 bg-blue-50 rounded-lg shadow-inner border border-blue-200">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <button
            ...
            disabled={combinedLoading || !lessonTitle.trim()}
          >
      ...
      {lessonPlan.content && !combinedLoading && (
        <div className="lesson-plan-output border border-gray-300 rounded-lg p-6 bg-white shadow-xl">
          <div className="text-center mb-8">
            <img src="https://picsum.photos/100/100" alt="DepEd Logo" className="mx-auto h-24 w-24 mb-2" />
